...
const HomeProduct = ({ products }) => {
    ...
    className="mx-auto px-10 py-20 flex flex-col md:flex-row items-center gap-6 bg-light-background dark:bg-dark-background dark:text-dark-text">
      ...
      <div className="md:w-1/3 text-center md:text-left">
        <h2 className="text-4xl border-b border-light-primary dark:border-dark-primary text-light-text dark:text-dark-text font-EncodeSansCondensed md:text-5xl pb-4">Latest Products</h2>
